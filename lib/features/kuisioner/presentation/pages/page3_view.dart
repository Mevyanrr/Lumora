...
class Page3View extends StatefulWidget {
  final TextEditingController kondisiBayiController;
  final TextEditingController pilKontrolController;

  const Page3View({
    super.key,
    required this.kondisiBayiController,
    required this.pilKontrolController,
  });
                        ...
                        builder: (context, state) {
                          return Column(
                            ...
                            children: _kondisiOptions.map((option) {
                              final isSelected = state.kondisiBayi.contains(option);
                              return InkWell(
                                onTap: () {
                                  context.read<KuisionerBloc>().add(
                                    ToggleKondisiBayi(option),
                                  );
                                },
                                child: Padding(
                                  padding: EdgeInsets.symmetric(
