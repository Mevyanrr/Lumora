  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: sizewidth*18/fullwidth, vertical: sizeheight*84/fullheight),
          child: Column(
            children: [
              CardTopanalisisresult(size: size, image: 'assets/images/analisis-good.png', desc1: 'Kerja bagus, parents!', desc2: 'Makanan anda sudah cukup bergizi untuk perkembangan Si Kecil.'),
