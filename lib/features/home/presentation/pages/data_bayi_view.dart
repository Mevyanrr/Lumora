              ...
              StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData && !_isInitialized) {
                      ...
                      widget.tbController.text =
                          babyData.tinggiBadan.toString();
                      widget.lingkarKepalaController.text =
                          babyData.lingkarKepala.toString();

                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        if (!mounted) return;
                        final bloc = context.read<KuisionerBloc>();
                        bloc.add(IsiNama(babyData.nama));
                        bloc.add(IsiTglLahir(babyData.tanggalLahir));
                        bloc.add(IsiBB(babyData.beratBadan));
                        bloc.add(IsiTB(babyData.tinggiBadan));
                        bloc.add(IsiLK(babyData.lingkarKepala));
                        bloc.add(IsiGender(
                            babyData.jenisKelamin)); 
                        bloc.add(PilAktivitasBayi(
                            babyData.kondisi ?? '')); 
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.circular(sizewidth * 20 / fullwidth),
                        border: Border.all(
                          ...
                          children: [
                            ...
                            CustomTxtField(
                              ...
                              onChanged: (value) {
                                context
                                    .read<KuisionerBloc>()
                                    .add(IsiBB(double.tryParse(value) ?? 0));
                              },
                            ),
                            SizedBox(height: sizeheight * 12 / fullheight),
                            Text(
                            ...
                            CustomTxtField(
                              ...
                              onChanged: (value) {
                                context
                                    .read<KuisionerBloc>()
                                    .add(IsiTB(double.tryParse(value) ?? 0));
                              },
                            ),
                            SizedBox(height: sizeheight * 12 / fullheight),
                            Text(
                            ...
                            CustomTxtField(
                              ...
                              onChanged: (value) {
                                context
                                    .read<KuisionerBloc>()
                                    .add(IsiLK(double.tryParse(value) ?? 0));
                              },
                            ),
