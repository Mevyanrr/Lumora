...
class CardTipsgizi extends StatelessWidget {
  final List<TipsGiziItem> items;
  final Size size;

  const CardTipsgizi({super.key, required this.items, required this.size});
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(
              left: sizewidth * 10 / fullwidth,
              right: sizewidth * 10 / fullwidth,
          ...
          ...items.map((item) {
            return Padding(
              ...
              child: Row(
                ...
                children: [
                  SvgPicture.asset(
                    "assets/icons/nutriguide-lamp.svg",
                    width: sizewidth * 22.5 / fullwidth,
                  ),
