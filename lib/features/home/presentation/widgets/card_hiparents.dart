...
class CardHiparents extends StatefulWidget {
  final String desc;
  const CardHiparents({super.key,
  required this.desc});

  @override
  State<CardHiparents> createState() => _CardHiparentsState();
}

class _CardHiparentsState extends State<CardHiparents> {
  @override
